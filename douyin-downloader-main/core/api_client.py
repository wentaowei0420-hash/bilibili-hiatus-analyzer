...
try:
    ...
    _ABOGUS_IMPORT_ERROR = True
else:
    _ABOGUS_IMPORT_ERROR = False
...
class DouyinAPIClient:
    ...
    def __init__(self, cookies: Dict[str, str], proxy: Optional[str] = None):
        ...
        if not self._abogus_enabled and _ABOGUS_IMPORT_ERROR:
            logger.warning(
                "ABogus signer unavailable, falling back to X-Bogus. "
                "Install optional dependency 'gmssl' to enable ABogus signing."
            )
